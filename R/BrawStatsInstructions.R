BrawInstructions <- function(HelpType="Plan") {
  ...
  switch(HelpType,
         ...
         "Key"={output<-c(
           ...
           '   <td class="here">',
           '<b>Standard</b>',
           '<br><b>rs</b> sample effectsize',
           '<br><b>rp</b> population effectsize',
           '<br><b>re</b> sample error',
           '<br><b>n</b> sample size',
           '<br><b>p</b> p-value',
           '   </td>',
           '   <td class="here">',
           '<b>Power</b>',
           '<br><b>ws</b> sample power (rs & n)',
           '<br><b>wp</b> population power (rp & n)',
           '<br><b>wn</b> required sample size from rs',
           '   </td>',
           '   <td class="here">',
           '<b>Replication</b>',
           '<br><b>ro</b> original rs',
           '<br><b>no</b> original n',
           '<br><b>po</b> original p',
           '   </td>',
           ' </tr>',
           '</table>',
           '')
