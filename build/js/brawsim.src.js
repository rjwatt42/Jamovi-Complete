									...
									controls: [
										{
											...
											controls: [
												...
												},
												{
													type: DefaultControls.Label,
													typeName: 'Label',
													label: "distribution of possible values. The population effect size has a"
												},
												{
													type: DefaultControls.Label,
													typeName: 'Label',
													label: "probability of being set to zero. ie. the hypothesis is wrong."
												},
												{
													type: DefaultControls.Label,
													typeName: 'Label',
												...
												},
												{
													...
													controls: [
														...
														},
														{
															type: DefaultControls.Label,
															typeName: 'Label',
															label: "ratio of likelihoods of rp=rs vs rp=0, given rs",
															minWidth: 300
														}
													]
												}
