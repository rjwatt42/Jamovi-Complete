				...
				},
				{
					...
					controls: [
						...
						},
						{
							...
							name: "typeExplore",
							events: [
								{ execute: require('./BrawSim.events').onChange_typeExplore }
							]
						},
						{
							type: DefaultControls.ComboBox,
